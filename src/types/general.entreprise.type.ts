...
const ListTypesContribuableEntreprise : TypeContribuableEntreprise = [
  {
    sigle: 'EI',
...
// export type RegimeFiscalType = 
//   | 'REEL'
//   | 'TPS'

// // === Définition des types juridiques d'entreprise au Bénin ===
// export type FormeJuridiqueType =
...
//   sigle : string,
//   definition : string,
//   assusertissment : string
// }


// export interface FormeJuridique {
//   sigle : FormeJuridiqueType,
//   description : string
// }


// export interface RegimeFiscal {
//   sigle : RegimeFiscalType,
//   description : string
// }

// export type NatureContribuableType = 'PERSONNE_PHYSIQUE' | 'PERSONNE_MORALE' | 'NON_ENREGISTRE';
...
//  */
// export function getNatureContribuable(forme: FormeJuridique): NatureContribuableType {
//   switch (forme) {
//     case 'EI':
...
//  */
// export function getRegimeFiscal(forme: FormeJuridique): StatutFiscal {
//   switch (forme) {
//     /**
//      * EI : Entreprise Individuelle
