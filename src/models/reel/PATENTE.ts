...
//  /**
//    * Méthode utilitaire pour obtenir un résumé des calculs
//    */
//   public obtenirResume(): string {
//     const resultat = this.calculerPatente();
    
//     return `
// === RÉSUMÉ DU CALCUL DE PATENTE ===
// Type d'entreprise: ${this.donnees.typeEntreprise}
// Commune: ${this.donnees.commune}
// Âge de l'entreprise: ${this.donnees.ageEntrepriseMois} mois

// --- DÉTAIL DES CALCULS ---
// Droit fixe: ${resultat.droitFixe.toLocaleString()} FCFA
// Droit proportionnel: ${resultat.droitProportionnel.toLocaleString()} FCFA
// Patente supplémentaire: ${resultat.patenteSupplementaire.toLocaleString()} FCFA
// Patente complémentaire: ${resultat.patenteComplementaire.toLocaleString()} FCFA

// --- RÉSULTAT ---
// Patente de base: ${resultat.patenteBase.toLocaleString()} FCFA
// Exemption accordée: ${resultat.exemption ? 'Oui' : 'Non'}
// Patente finale: ${resultat.patenteFinale.toLocaleString()} FCFA

// --- PAIEMENT ---
// Acompte (50%): ${resultat.acompte.toLocaleString()} FCFA
// Solde: ${resultat.solde.toLocaleString()} FCFA
//     `.trim();
//   }
...
/*
const donneesExemple: DonneesPatente = {
  typeEntreprise: 'classique',
  chiffreAffaires: 500000000, // 500 millions
  zone: 'zone1',
  commune: 'cotonou',
  locaux: [
    { valeurLocative: 1200000, estNouveauLocal: false },
    { valeurLocative: 800000, estNouveauLocal: true, moisRestants: 6 }
  ],
  marchePublicHT: 50000000, // 50 millions
  ageEntrepriseMois: 24
};

// Utilisation avec la classe
const calculateur = new CalculateurPatentes(donneesExemple);
const resultat = calculateur.calculerPatente();
console.log(calculateur.obtenirResume());

// Ou utilisation directe avec la méthode statique
const resultatDirect = CalculateurPatentes.calculer(donneesExemple);
*/
